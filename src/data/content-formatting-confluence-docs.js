...
The app is actively updated. Check the Atlassian Marketplace listing for the latest release notes and version history.`,
        },
        {
          ...
          videoGallery: {
            playlistUrl:
              "https://www.youtube.com/playlist?list=PLACoCS_WiVwRpkORYCho-5uakGUo7sNYp",
            videos: [
              {
                id: "JDZ-kBDXeL0",
...
| **Step** | Action |
|---|---|
| **1** | Go to **[marketplace.atlassian.com](https://marketplace.atlassian.com)** and search for **["Content Formatting Macros: Tabs Navigation Visibility CSS"](https://marketplace.atlassian.com/apps/3890258352/content-formatting-macros-tabs-navigation-visibility-css)** |
      ...
      articles: [
        {
          ...
          title: "Demo Doc",
          content: `
<iframe src="https://clovity-website.s3.ap-south-1.amazonaws.com/Content_Formatting_Macros_Tabs_Navigation_Visibility_CSS_Demo_Doc_d1707f39ef.pdf" width="100%" height="900" style="border:1px solid #e2e8f0;border-radius:10px;display:block;" title="PDF"></iframe>
`,
        },
      ],
    },
      ...
      articles: [
        {
          ...
          title: "Competitor Comparison",
          content: `
<iframe src="https://clovity-website.s3.ap-south-1.amazonaws.com/Competitor_Doc_Content_Formatting_032034c63d.pdf" width="100%" height="900" style="border:1px solid #e2e8f0;border-radius:10px;display:block;" title="PDF"></iframe>
`,
        },
      ],
    },
      ...
      articles: [
        {
          ...
          content: `
<iframe src="https://clovity-website.s3.ap-south-1.amazonaws.com/Content_Formatting_Macros_Tabs_Navigation_Visibility_CSS_1b69b9efda.pdf" width="100%" height="900" style="border:1px solid #e2e8f0;border-radius:10px;display:block;" title="PDF"></iframe>
`,
        },
        {
          ...
          content: `
<iframe src="https://clovity-website.s3.ap-south-1.amazonaws.com/Content_Formatting_Macros_Tabs_Navigation_Visibility_CSS_AGC_68c0245278.pdf" width="100%" height="900" style="border:1px solid #e2e8f0;border-radius:10px;display:block;" title="PDF"></iframe>
`,
        },
      ],
    },
