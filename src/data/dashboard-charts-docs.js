...
**Turn Jira dashboards into clear reporting insights**

Jira manages work, but reporting can feel scattered and manual. This app simplifies it by bringing templates, charts, and advanced analytics together making dashboards easier to build, read, and use.

## What the app includes

| **Gadget** | **What it does** |
| --- | --- |
| Custom | Visual reports with 10 chart types |
| Issue List | Detailed issue tables on dashboards. |
| Dynamic Filter Controller | Shared dashboard filtering across all gadgets. |
| Time in Status | Workflow time analytics per stage. |
| Pivot Table | Cross-tabulation and aggregation. |
| Cumulative Flow Diagram | Flow and WIP tracking over time. |
| WIP Aging Charts | In-progress item aging analysis. |

Together, these seven gadgets help teams understand their Jira data, explore issue details, track process health, and interact with the full dashboard from one place.

## What Customers Can Do With The App

**Built for everyday Jira reporting needs**

This app helps create dashboards for common team and business use cases:

- Sprint health dashboards.
- Bug and defect tracking dashboards.
- Team workload reports.
- Release progress dashboards.
- Leadership and stakeholder reporting.
- Process bottleneck analysis (Time in Status).
- Multi-dimensional aggregation (Pivot Table).
- Flow and WIP monitoring (CFD + WIP Aging).

**Core Value**

- Better visibility into Jira data.
- Faster dashboard reporting.
- Less manual effort.
- More interactive dashboards.
- Easier reporting for teams and stakeholders.

## Seven Gadgets, One Connected Dashboard

**Custom Charts**

Turns Jira issue data into visual reports that are easy to understand. Supports 10 chart types including Pie, Bar, Grouped Bar, Stacked Bar, Line, 2D Line, Table, 2D Table, Funnel, and Tile.

**Issue List**

Shows the actual Jira issues in a configurable table format with Smart Labels, Quick Filters, and export support.

**Dynamic Filter Controller**

Connects all charts and issue tables with one shared filtering experience - one filter bar updates every gadget simultaneously.

**Time in Status**

Analyzes how long issues spend in each workflow status using the full issue changelog. Answers "where does work get stuck?" with 7 report types and custom status groupings for Cycle Time and Lead Time.

**Pivot Table**

Summarizes Jira issues in a cross-tabulation matrix. Group issues by up to 3 row fields and 3 column fields, aggregate by count/sum/average/min/max, and visualize as a table, heatmap, or chart.

**Cumulative Flow Diagram**

Shows how work accumulates across workflow stages over time. Tracks sprint health, identifies bottlenecks visually, and supports 6 band modes including board columns and custom fields.

**WIP Aging Charts**

Plots in-progress items as a scatter chart where each dot's position shows how long that item has been active. Instantly reveals stalled work and SLA risks with configurable average, threshold, and percentile reference lines.

## Basic Setup: How This App Works

Getting started is simple. Add one of the app's gadgets to a Jira dashboard, choose the Jira data you want to report on, and configure how that information should appear.

**To add a gadget:**

- Open an existing Jira dashboard or create a new one.
- Click **Add gadget.**
- Search for the gadget you want to use (Custom Charts, Issue List, Dynamic Filter Controller, Time in Status, Pivot Table, Cumulative Flow Diagram, WIP Aging Charts).
- Add the gadget to the dashboard.
- Select the data source and adjust the settings.
- Click **Save gadget.**

Before saving, the gadget opens in edit mode so you can review the setup, preview the result, and make changes as needed.

## Custom Charts

**Visual reporting directly inside Jira dashboards**

Custom Charts helps teams turn Jira issue data into visual reports that are easier to read than a long list of issues.
...
- Funnel charts for stage flow.
- Tile charts for key numbers.
- Grouped Bar for multi-series comparison.
- Stacked Bar for composition breakdown.
- 2D Line for parallel trend comparison.
- 2D Table for cross-tab matrices.

**Main Chart Features**

- Chart By - choose how issues are grouped.
- Calculations - Count, Sum, Average + Goal/Trend/Average/Cumulative lines.
- Display settings for readability and presentation.
- 2D Chart Support for deeper cross-dimensional analysis.
- Templates for fast setup.
- Export to PNG, PDF, and CSV.

## Issue List

**See The Real Issues Behind The Report**

Issue List helps teams display Jira issues in a dashboard table that is clear, practical, and easy to work with.

**Main Issue List Features**

- Configurable Columns - any Jira field.
- Column Reordering - drag and drop.
- Quick Filters - one-click filter buttons.
- Smart Labels - visual badges based on JQL or filter conditions.
- Sorting - by any column.
- Pagination & display customization.
- Templates - pre-built table layouts.
- Export options - CSV, PNG, PDF.

## Dynamic Filter Controller

**Connect The Whole Dashboard With Shared Filters**

Dynamic Filter Controller connects all gadgets. Instead of changing each gadget one by one, teams add one shared filter bar at the top of the dashboard.

**Supported Filter Types:** Jira fields · Text search · Custom JQL · Saved filters

**Preset Tabs**

Named filter views (e.g., All Work, My Issues, This Sprint, Bugs Only) let users switch between preset dashboard states with a single click.

## Time in Status

**Measure How Long Work Sits in Each Stage**

Time in Status reads the full issue changelog to calculate exactly how long each issue has spent in every workflow status - not just the current state, but the complete history of transitions.

**Report Types**

| **Report** | **What It Shows** |
| --- | --- |
| Time in Status | Per-issue time in each status |
| Average Time | Mean time per status across all issues |
| Time in Status per Date | Temporal trend of time in status |
| Status Count | Volume of issues that passed through each status |
| Transition Count | How many times each status was visited (rework detection) |
| Time in Assignee | Time spent with each assigned person |
| Status Entrance Date | When each issue first entered each status |

**Key Features**

- Status Groups - combine statuses into named bands (built-in Cycle Time and Lead Time groups).
- Work Schedule - configure per-day working hours so calculations exclude non-working time.
- 10 time format options - Business Days/Hours/Minutes, Decimal Days/Weeks, HoursMinutes, and more.
- Date range filter - scope analysis to rolling periods or custom date windows.
- Export - CSV and PNG.

## Pivot Table

**Summarize Any Jira Data as a Cross-Tabulation**

The Pivot Table gadget transforms Jira issue data into a cross-tabulation matrix. Place any combination of Jira fields on rows and columns, choose how to aggregate the values, and display the result as a table, heatmap, or chart.

**Aggregation Methods**

Count · Sum · Average · Minimum · Maximum · Count % · Sum %

**Display Types (9)**

Table · Table Heatmap · Table Row Heatmap · Table Column Heatmap · Column Chart · Bar Chart · Line Chart · Stacked Area Chart · Pie Chart

**Key Features**

- Up to 3 row fields and 3 column fields for multi-level grouping.
- Make values clickable - click any cell to open the matching Jira issue list.
- Heatmap coloring - Red, Blue, Green, or Grey base color.
- Totals row/column, percentage column, average column.
- Date field formatting - week, month, quarter, year display formats.
- Export - CSV and PNG.

## Cumulative Flow Diagram

**Track Work Flow Across Your Pipeline Over Time**

The CFD shows how issues accumulate across workflow stages over time as a stacked area chart. Each band represents a stage; the width of a band on any given day shows how many issues were in that stage.

**Band Modes**

Status Categories · Individual Statuses · Board Columns · Board Column Categories · Work Item Types · Custom Field Values

**Key Features**

- Board integration - use column definitions from a Jira Software board.
- Include sub-tasks toggle.
- Latest sprint auto - always shows the current sprint without reconfiguring.
- Exclude/reorder/recolor bands individually.

## WIP Aging Charts

**Identify Stalled Work Before It Becomes a Problem**

WIP Aging Charts plots each in-progress issue as a dot on a scatter chart. The dot's horizontal position shows how long the issue has been in its current state. Reference lines mark your average age, SLA threshold, and statistical percentile so outliers are immediately visible.

**Age Calculation Methods**

- Time since last entry in current status
- Sum of all time in current status (counts re-entry)
- Sum of all time in the category of current status
- Time since first entry in current status category
- Time since work item creation

**Reference Lines**

- **Average line** - mean age of all current WIP.
- **Threshold line** - your SLA boundary (configurable value).
- **Percentile line** - e.g., 85th percentile for Kanban SLE tracking.

## Example Use Cases

**Sprint Dashboard**

Use Custom Charts to show sprint progress, Issue List to review active work, Dynamic Filter Controller for filter switching, and WIP Aging to spot stalled items before the sprint ends.

**Bug Tracking Dashboard**

Use Custom Charts to monitor bug trends, Issue List to review open bugs by priority, and Time in Status to identify which stages bugs are sitting in longest.

**Team Workload Dashboard**

Use Custom Charts to compare work across assignees, Pivot Table for a multi-dimensional breakdown (assignee x status x priority), and Issue List to inspect individual tasks.

**Release Dashboard**

Use the dashboard to track release progress, review blockers, and monitor issue details connected to the release.

**Release Readiness Dashboard**

Use CFD to track flow across the release pipeline, WIP Aging to flag at-risk items, and Custom Charts to show completion percentage.

**Process Analytics Dashboard**

Use Time in Status for Cycle Time and Lead Time measurement, CFD for flow health, and WIP Aging for SLA monitoring - a complete Agile/Kanban analytics suite.

## Why Customers Use This App

- Clearer visibility into Jira data.
- Less manual reporting work.
- Better combination of summary and detail.
- More interactive dashboards.
- Deeper process analytics without leaving Jira.
- Easier reporting for meetings and reviews.
...
<div style="border:1px solid #e2e8f0;border-radius:10px;padding:24px;margin-top:32px;text-align:center;background:#f8fafc;">
  ...
  <div style="display:flex;gap:10px;flex-wrap:wrap;justify-content:center;">
    <a href="https://clovity-website.s3.ap-south-1.amazonaws.com/Dashboard_Demo_Doc_a79097bdc7.pdf" target="_blank" rel="noopener noreferrer" style="background:#0052CC;color:white;padding:10px 22px;border-radius:7px;text-decoration:none;font-size:13px;font-weight:600;display:inline-block;">Download PDF</a>
</div>
</div>
`,
        },
      ...
      articles: [
        {
          ...
          title: "Sales Doc",
          content: `
*Stop Digging for Data. Start Visualizing Success.*
...
| **Gadget** | **Description** |
| --- | --- |
| **Custom Charts** | Build visual reports with 10 chart types - 1D, 2D charts, tables, and KPI tiles. |
| **Issue List** | Professional interactive tables with Smart Labels, Quick Filters, and export. |
| **Dynamic Filter Controller** | Command center for dashboard filtering - one bar controls all connected gadgets. |
| **Time in Status** | Measure how long work spends in each stage. Identify bottlenecks with Cycle Time and Lead Time analytics. |
| **Pivot Table** | Cross-tabulation with 9 display types, 7 aggregation methods, and drill-through to Jira issues. |
| **Cumulative Flow Diagram** | Visualize work flow across pipeline stages over time. Track WIP, spot bottlenecks & monitor sprint health. |
| **WIP Aging Charts** | Scatter plot showing how long in-progress work has been active. Flag SLA risks with configurable reference lines. |

## Security You Can Trust

- **Run on Atlassian** - No external servers, no data leaving your Atlassian infrastructure.
...
Filter multiple connected charts and issue lists instantly with a single click. The Dynamic Filter Controller updates all seven gadgets simultaneously.

**10+ Chart Types (1D & 2D):**
Build pie, bar, line, funnel, and tile charts, plus advanced 2D matrix visualizations. Every chart type has full display customization.

**Custom JQL Segmentation:**
Define custom chart segments using advanced JQL queries instead of basic field groupings. Overlapping segments assign each issue to the first matching segment only.

**Advanced Calculations & Reference Lines:**
Track performance against targets using Goal, Trend, Average, and Cumulative Total lines on any bar or line chart.

**Multi-Dimensional Pivot Analysis:**
Summarize any Jira data across up to 3 row fields and 3 column fields. Aggregate by count, sum, average, min, or max. Click any cell to drill through to the contributing issues.

**Time-Based Process Analytics:**
Measure Cycle Time, Lead Time, & status transition counts with the Time in Status gadget - powered by actual issue changelog data, not current state snapshots.
...
<div style="border:1px solid #e2e8f0;border-radius:10px;padding:24px;margin-top:32px;text-align:center;background:#f8fafc;">
  ...
  <div style="font-size:13px;color:#6b7280;margin-bottom:18px;">Download or open in your browser.</div>
  <div style="display:flex;gap:10px;flex-wrap:wrap;justify-content:center;">
    <a href="https://clovity-website.s3.ap-south-1.amazonaws.com/Dashboard_Sales_Doc_3_8936d1da1a.pdf" target="_blank" rel="noopener noreferrer" style="background:#0052CC;color:white;padding:10px 22px;border-radius:7px;text-decoration:none;font-size:13px;font-weight:600;display:inline-block;">Download PDF</a>
  </div>
</div>
`,
        },
      ...
      articles: [
        {
          ...
          title: "Competitor Comparison",
          content: `
This comparison covers the core dashboard and reporting capabilities of Dashboard Templates, Charts, Graphs & Reports for Jira across key feature areas - benchmarked against leading Jira charting apps on the Atlassian Marketplace.

## Feature Coverage

| **Feature** | **Dashboard Templates, Charts, Graphs & Reports for Jira** |
| --- | --- |
| 10 Chart Types (Pie, Bar, Grouped Bar, Stacked Bar, Line, 2D Line, Table, 2D Table, Funnel, Tile) | <div style="display:flex;justify-content:center;align-items:center;"><span style="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:#16a34a;border-radius:50%;flex-shrink:0;"><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 6L5 8.5L9.5 3.5" stroke="white" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></span></div> |
| Dynamic Filter Controller (Shared Dashboard Filter Bar) | <div style="display:flex;justify-content:center;align-items:center;"><span style="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:#16a34a;border-radius:50%;flex-shrink:0;"><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 6L5 8.5L9.5 3.5" stroke="white" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></span></div> |
| Time in Status (Cycle Time, Lead Time) | <div style="display:flex;justify-content:center;align-items:center;"><span style="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:#16a34a;border-radius:50%;flex-shrink:0;"><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 6L5 8.5L9.5 3.5" stroke="white" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></span></div> |
| WIP Aging Charts | <div style="display:flex;justify-content:center;align-items:center;"><span style="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:#16a34a;border-radius:50%;flex-shrink:0;"><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 6L5 8.5L9.5 3.5" stroke="white" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></span></div> |
| Cumulative Flow Diagram | <div style="display:flex;justify-content:center;align-items:center;"><span style="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:#16a34a;border-radius:50%;flex-shrink:0;"><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 6L5 8.5L9.5 3.5" stroke="white" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></span></div> |
| Pivot Table (9 Display Types) | <div style="display:flex;justify-content:center;align-items:center;"><span style="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:#16a34a;border-radius:50%;flex-shrink:0;"><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 6L5 8.5L9.5 3.5" stroke="white" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></span></div> |
| Issue List with Custom Columns | <div style="display:flex;justify-content:center;align-items:center;"><span style="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:#16a34a;border-radius:50%;flex-shrink:0;"><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 6L5 8.5L9.5 3.5" stroke="white" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></span></div> |
| Smart Labels (Conditional Badges) | <div style="display:flex;justify-content:center;align-items:center;"><span style="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:#16a34a;border-radius:50%;flex-shrink:0;"><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 6L5 8.5L9.5 3.5" stroke="white" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></span></div> |
| JQL Data Source Support | <div style="display:flex;justify-content:center;align-items:center;"><span style="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:#16a34a;border-radius:50%;flex-shrink:0;"><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 6L5 8.5L9.5 3.5" stroke="white" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></span></div> |
| Saved Filter Data Source Support | <div style="display:flex;justify-content:center;align-items:center;"><span style="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:#16a34a;border-radius:50%;flex-shrink:0;"><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 6L5 8.5L9.5 3.5" stroke="white" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></span></div> |
| Reference Lines (Goal, Trend, Average) | <div style="display:flex;justify-content:center;align-items:center;"><span style="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:#16a34a;border-radius:50%;flex-shrink:0;"><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 6L5 8.5L9.5 3.5" stroke="white" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></span></div> |
| Ready-Made Chart Templates | <div style="display:flex;justify-content:center;align-items:center;"><span style="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:#16a34a;border-radius:50%;flex-shrink:0;"><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 6L5 8.5L9.5 3.5" stroke="white" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></span></div> |
...
| Export to PNG, PDF, CSV | <div style="display:flex;justify-content:center;align-items:center;"><span style="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:#16a34a;border-radius:50%;flex-shrink:0;"><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 6L5 8.5L9.5 3.5" stroke="white" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></span></div> |
| Admin Settings (Global Feature Controls) | <div style="display:flex;justify-content:center;align-items:center;"><span style="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:#16a34a;border-radius:50%;flex-shrink:0;"><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 6L5 8.5L9.5 3.5" stroke="white" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></span></div> |
| Live Preview (Real-Time Configuration) | <div style="display:flex;justify-content:center;align-items:center;"><span style="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:#16a34a;border-radius:50%;flex-shrink:0;"><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 6L5 8.5L9.5 3.5" stroke="white" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></span></div> |
| Built on Atlassian Forge (Cloud-Native) | <div style="display:flex;justify-content:center;align-items:center;"><span style="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:#16a34a;border-radius:50%;flex-shrink:0;"><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 6L5 8.5L9.5 3.5" stroke="white" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></span></div> |
| AGC (Atlassian Government Cloud) Compatible | <div style="display:flex;justify-content:center;align-items:center;"><span style="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:#16a34a;border-radius:50%;flex-shrink:0;"><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 6L5 8.5L9.5 3.5" stroke="white" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></span></div> |

## Coverage Summary

**18 / 18 core dashboard and reporting capabilities supported - 100% coverage.**

Our app delivers complete coverage of enterprise Jira reporting foundations: JQL-based querying, 10 chart types, interactive dashboard filters, workflow analytics, flexible tables, and robust export & configuration sharing - packaged into a cohesive, user-friendly experience.

| **Category** | **What We Cover** |
| --- | --- |
| Chart Engine | 10 chart types across 5 categories - pie, bar (1D/grouped/stacked), line (1D/2D), table (1D/2D), funnel, tile |
| Interactive Dashboards | Dynamic Filter Controller with preset tabs, connecting all gadgets in real time |
| Process Analytics | Time in Status (Cycle Time/Lead Time), WIP Aging Charts, Cumulative Flow Diagram |
| Data Architecture | JQL, Projects, Saved Filters, Board, and Dynamic Filter Controller data sources |
| Issue List | Custom columns, smart labels, quick filters, sorting, pagination |
| Pivot Table | 9 display types, row/column heatmaps, clickable drill-through |
| Configuration | Templates, JSON import/export, live preview, admin feature controls |
| Export | PNG, PDF, and CSV from every gadget; JSON config export for backup and duplication |

<div style="border:1px solid #e2e8f0;border-radius:10px;padding:24px;margin-top:32px;text-align:center;background:#f8fafc;">
  <div style="font-size:15px;font-weight:700;color:#111827;margin-bottom:6px;">Competitor Comparison - Full PDF</div>
  <div style="font-size:13px;color:#6b7280;margin-bottom:18px;">Download or open in your browser.</div>
  <div style="display:flex;gap:10px;flex-wrap:wrap;justify-content:center;">
    <a href="https://clovity-website.s3.ap-south-1.amazonaws.com/Dashboard_Competitor_Doc_479c80e80b.pdf" target="_blank" rel="noopener noreferrer" style="background:#0052CC;color:white;padding:10px 22px;border-radius:7px;text-decoration:none;font-size:13px;font-weight:600;display:inline-block;">Download PDF</a>
  </div>
</div>
`,
        },
      ...
      articles: [
        {
          ...
          content: `
## Build Powerful Jira Dashboards Faster

**Plan smarter. Deliver faster. All in Jira.**

Dashboard Templates, Charts, Graphs & Reports for Jira is priced annually per Jira Cloud instance based on your total user count. Teams of up to 10 users get full access at no cost.
...
| 601 – 800 | $6,400.00 |
| 801 – 1,000 | $7,300.00 |
| 1,001 – 1,200 | $7,600.00 |
| 1,201 – 1,400 | $7,900.00 |
| 1,401 – 1,600 | $8,200.00 |
| 1,601 – 1,800 | $8,500.00 |
| 1,801 – 2,000 | $8,800.00 |
| 2,001 – 2,250 | $9,175.00 |
| 2,251 – 2,500 | $9,550.00 |
| 2,501 – 2,750 | $9,925.00 |
| 2,751 – 3,000 | $10,300.00 |
| 3,001 – 3,250 | $10,675.00 |
| 3,251 – 3,500 | $11,050.00 |
| 3,501 – 3,750 | $11,425.00 |
| 3,751 – 4,000 | $11,800.00 |
| 4,001 – 4,250 | $12,175.00 |
| 4,251 – 4,500 | $12,550.00 |
| 4,501 – 4,750 | $12,925.00 |
| 4,751 – 5,000 | $13,300.00 |
...
- **All features included** - Every pricing tier includes all 7 gadgets: Custom Charts, Issue List, Dynamic Filter Controller, Time in Status, Pivot Table, Cumulative Flow Diagram, and WIP Aging Charts.
...
Dashboard Templates, Charts, Graphs & Reports for Jira is available on **Atlassian Government Cloud (AGC)** — a FedRAMP-authorized deployment of Atlassian products built for U.S. federal, state, local, and tribal government agencies. AGC pricing is billed annually per instance based on your total user count. Teams of up to 10 users get full access at no cost.
...
| --- | --- |
| Up to 10 | $0.00 |
| 11 – 100 | Up to $2,370.00 |
| 101 – 250 | Up to $5,310.00 |
| 251 – 1,000 | Up to $9,885.00 |
| 1,001 – 2,500 | Up to $13,035.00 |
| 2,501 – 5,000 | Up to $18,285.00 |

<div style="border:1px solid #e2e8f0;border-radius:10px;padding:24px;margin-top:32px;text-align:center;background:#f8fafc;">
  <div style="font-size:15px;font-weight:700;color:#111827;margin-bottom:6px;">AGC App Pricing - Full PDF</div>
  <div style="font-size:13px;color:#6b7280;margin-bottom:18px;">Download or open in your browser.</div>
  <div style="display:flex;gap:10px;flex-wrap:wrap;justify-content:center;">
    <a href="https://clovity-website.s3.ap-south-1.amazonaws.com/Dashboard_Templates_Charts_Graphs_and_Reports_for_Jira_AGC_292b403cdc.pdf" target="_blank" rel="noopener noreferrer" style="background:#0052CC;color:white;padding:10px 22px;border-radius:7px;text-decoration:none;font-size:13px;font-weight:600;display:inline-block;">Download PDF</a>
  </div>
</div>
`,
        },
